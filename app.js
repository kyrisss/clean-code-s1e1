...
var createNewTaskElement=function(taskString){
    ...
    listItem.className = "todo-tasks__normal-mode";
    return listItem;
}
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("todo-tasks__edit-mode");
    ...
    listItem.classList.toggle("todo-tasks__normal-mode");
    listItem.classList.toggle("todo-tasks__edit-mode");
};
